    ...
    protected function templates()
    {
        ...
        foreach ($templates as $name => $data) {
            ...
            $objects[$name]->fromArray(array_merge([
                'templatename' => $name,
                'description' => $data['description'],
                'content' =>  "{include 'file:templates/".$data['file'].".tpl'}",
...
/*        // Elements chunks
        $vehicle->resolve('file', [
            'source' =>  $this->config['build'].'elements/chunks/',
        ...
        // Elements templates
        $vehicle->resolve('file', [
            'source' =>  $this->config['build'].'elements/templates/',
            'target' => "return MODX_CORE_PATH.'elements/';",
        ]);*/
        ...
        // Elements resources
        $vehicle->resolve('file', [
            'source' =>  $this->config['root'].'elements/resources/',
            'target' => "return MODX_CORE_PATH.'elements/';",
        ]);
...
$install = new rezdevPackage(MODX_CORE_PATH, $config);
